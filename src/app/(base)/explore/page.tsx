...
import { SearchedPosts, SearchParamsInput } from '@/components';
import Image from 'next/image';
import { usePostsInfiniteQuery } from '@/hooks';

export const metadata: Metadata = {
  title: 'Instabook | Explore',
  description: 'Explore posts on Instabook',
};
...
export default async function Page({ searchParams }: PageProps) {
  ...
  await Promise.all([
    queryClient.prefetchInfiniteQuery({ ...usePostsInfiniteQuery, queryKey: usePostsInfiniteQuery.queryKey(search) }),
  ]);
